...
<body>
    ...
    <div class="head-title-wrap">
        <h3 class="head-title">관리자 ID 로그인</h3>
    </div>
    <form action="/Doctorinhome/admin" method="post" class="loginForm">
        <div>
            <label for="admin_id" class="input-layout">
                <input type="text" id="id" name="admin_id" required placeholder="아이디" autocomplete="off">
            </label>
        </div>
        <div>
            <label for="admin_pwd" class="input-layout">
                <input type="password" id="pwd" name="admin_pwd" required placeholder="비밀번호" autocomplete="off">
            </label>
        </div>
    ...
    <div class="info-find">
        아직 계정이 없으신가요?
        <a href="/Doctorinhome/adminJoin">관리자 회원가입</a>
    </div>
</section>
</main>
</body>
